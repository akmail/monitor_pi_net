...
# echo "creating target report directory /var/log/monitor_pi_net/ and mounting it as a ramdisk in /etc/fstab ..."
# mkdir -p /var/log/monitor_pi_net
# chmod a+rwx /var/log/monitor_pi_net
...
if [ -d "/var/www/html" ]; then
    echo "found /var/www/html, creating link to /var/log/monitor_pi_net ..."
    ln -s /var/log/monitor_pi_net /var/www/html/monitor_pi_net
else
    echo "no /var/www/html directory found. Please add html report /var/log/monitor_pi_net manually to your web server!"
fi
